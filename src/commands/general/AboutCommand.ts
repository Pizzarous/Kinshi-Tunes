...
const pkg = JSON.parse(readFileSync(new URL("../../../package.json", import.meta.url)).toString()) as {
    version: string;
};

@Command<typeof AboutCommand>({
...
export class AboutCommand extends BaseCommand {
    public async execute(ctx: CommandContext): Promise<void> {
        const values = [
            ...
            [""],
            [i18n.__("commands.general.about.sourceCodeString"), "https://github.com/Pizzarous/Kinshi-Tunes"]
        ];
